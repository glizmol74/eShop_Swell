...
class Productos extends Seeder
{
    public function run()
    {
        ...
        if ( 1 == 1) {
            ...
            DB::table('productos')->insert(['pro_es_nombre' => 'Gel Sanitizante',
                'pro_en_nombre' => 'Sanitizing Gel',
            ...
            DB::table('productos')->insert(['pro_es_nombre' => 'Blem Lustramuebles Aerosol',
                'pro_en_nombre' => 'Blem Furniture Polish Spray',
                'pro_es_descripcion_larga' => '',
                'pro_en_descripcion_larga' => '',
                'pro_tipo' => 2,
                'pro_ficha' => null,
            ...
            DB::table('productos')->insert(['pro_es_nombre' => 'Bobina Toalla HS x 400 Mts x Un.',
                'pro_en_nombre' => 'HS Towel Coil x 400 Mts x Un.',
                'pro_es_descripcion_larga' => '',
                'pro_en_descripcion_larga' => '',
                'pro_tipo' => 2,
                'pro_ficha' => null,
            ...
            DB::table('productos')->insert(['pro_es_nombre' => 'Bobina Toalla HD Elegante 1035 40 Mts x 19,5 Cm x Un.',
                'pro_en_nombre' => 'Elegant HD Towel Roll 1035 40 Mts x 19.5 Cm x Un.',
                'pro_es_descripcion_larga' => '',
                'pro_en_descripcion_larga' => '',
                'pro_tipo' => 2,
                'pro_ficha' => null,
            ...
            DB::table('productos')->insert(['pro_es_nombre' => 'Desengrasante Ultra',
            'pro_en_nombre' => 'Ultra Degreaser',
            'pro_es_descripcion_larga' => '',
            'pro_en_descripcion_larga' => '',
            'pro_tipo' => 1,
            'pro_ficha' => null,
        ...
        if ( 1 == 1) {
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_precio_emp' => 2868.70,
                'pat_precio_esp' => 2486.21,
                'pat_precio_dst' => 199.52,
                'pat_cod_tempo' => 'MDZ1-006',
                'pat_estado' => 1,
                'pat_orden' => 1,
                'pat_add' => 1
            ]);
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_precio_emp' => 2868.70,
                'pat_precio_esp' => 2486.21,
                'pat_precio_dst' => 707.95,
                'pat_cod_tempo' => 'NRP1-008',
                'pat_estado' => 1,
                'pat_orden' => 1,
                'pat_add' => 1
            ]);
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_precio_emp' => 2868.70,
                'pat_precio_esp' => 2486.21,
                'pat_precio_dst' => 427.98,
                'pat_cod_tempo' => 'ECQ1-001',
                'pat_estado' => 1,
                'pat_orden' => 1,
                'pat_add' => 1
            ]);
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_attr' => 4,
                'pat_imagen' => null,
                'pat_precio_usr' => 192.96,
                'pat_precio_emp' => 144.72,
                'pat_precio_esp' => 125.42,
                'pat_precio_dst' => 96.48,
                'pat_cod_tempo' => '0703',
                'pat_estado' => 1,
                'pat_orden' => 1,
                'pat_add' => 1
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_attr' => 6,
                'pat_imagen' => null,
                'pat_precio_usr' => 1336.05,
                'pat_precio_emp' => 1002.04,
                'pat_precio_esp' => 868.43,
                'pat_precio_dst' => 668.03,
                'pat_cod_tempo' => '0029',
                'pat_estado' => 1,
                'pat_orden' => 2,
                'pat_add' => 1
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_attr' => 7,
                'pat_imagen' => null,
                'pat_precio_usr' => 3105.37,
                'pat_precio_emp' => 2329.03,
                'pat_precio_esp' => 2018.48,
                'pat_precio_dst' => 1552.69,
                'pat_cod_tempo' => '0263',
                'pat_estado' => 1,
                'pat_orden' => 3,
                'pat_add' => 1
            ...
            DB::table('productos_atributos')->insert([
                ...
                'pat_attr' => 8,
                'pat_imagen' => null,
                'pat_precio_usr' => 225.50,
                'pat_precio_emp' => 169.13,
